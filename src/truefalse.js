import {closeModalAnswer,showFinalScore,emitConfetti,shuffleArray,updateScore,updateNbQuestion,displayModalAnswer} from "./quiz";
var questions = [
    {
  ...
  export { displayQuestionTrueFalse,handleAnswerClickTrueFalse,startStatTrueFalse };